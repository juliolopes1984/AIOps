# Pós-Graduação em AIOps - Exercícios Práticos

Bem-vindo ao repositório central de exercícios e laboratórios da **Pós-Graduação em AIOps**. Este espaço foi projetado para consolidar o conhecimento técnico necessário para integrar Inteligência Artificial às operações de TI (SRE, DevOps e Cloud).
...
Para acompanhar a base teórica e as demonstrações de cada exercício, acesse a plataforma oficial:

🔗 [Plataforma DevOps Pro](https://plataforma.devopspro.com.br/)

---

## 🛠️ Stack Tecnológica Recomendada

Para a execução dos exercícios deste repositório, recomenda-se:
- **Linguagem:** Python 3.12+
- **Containerização:** Docker, Docker Compose e Kubernetes
- **Orquestração & Automação:** Ansible e Terraform

---
*Documentação mantida para evolução e contribuição no conhecimento de IA.*